...
public class ProviderClient {
  ...
  public ProviderClient(
      ProviderClientId id, UserId userId, ServiceProviderId providerId, CreatedAt createdAt) {
    this.id = id;
    this.userId = userId;
  ...
  public static ProviderClient of(UserId userId, ServiceProviderId providerId) {
    return new ProviderClient(
        ProviderClientId.generate(), userId, providerId, new CreatedAt(LocalDateTime.now()));
  }
}
